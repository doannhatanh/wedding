...
export const Calendar = () => {
  return (
    <section className="pb-12 pt-20 weddingdate-section section-bg-affect" id="weddingdate">
      <div className="container-fluid">
        <div className="w-100">
          <div className="m-auto pt-5 pb-3 aos-init aos-animate" data-aos="fade-up">

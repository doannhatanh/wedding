...
export const useSetting = () => {
  ...
  useLayoutEffect(() => {
    ...
    setColumns(viewportSize < 480 ? 2 : viewportSize < 900 ? 2 : 3);
    setSpacing(viewportSize < 480 ? 10 : viewportSize < 900 ? 3 : 7);
    setPadding(viewportSize < 480 ? 10 : viewportSize < 900 ? 2 : 5);
    setTargetRowHeight(viewportSize < 480 ? 100 : viewportSize < 900 ? 150 : 200);
  }, []);

  return { photos, layout, columns, targetRowHeight, spacing, padding, width };
};
